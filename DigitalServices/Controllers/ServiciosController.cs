...
namespace DigitalServices.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdServicio,Dimenciones,Duracion,Descripcion,Precio")] Servicios servicios)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdServicio,Dimenciones,Duracion,Descripcion,Precio")] Servicios servicios)
        {
            if (ModelState.IsValid)
            {
